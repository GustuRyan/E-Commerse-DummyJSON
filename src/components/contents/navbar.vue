...
<template>
    <nav class="w-screen h-20 px-[80px] py-[24px] fixed flex justify-between bg-white z-50 border-b-[1px]">
        <ul class="flex justify-between items-center mb-0 text-[16px] font-['Antique'] font-[400] text-[#888888] w-[360px]">
            <router-link to="/" class="hover:font-bold hover:text-[#676767]" active-class="font-bold text-[#84BAE8]">
                HOME
            </router-link>
            <router-link to="/about" class="hover:font-bold hover:text-[#676767]" active-class="font-bold text-[#84BAE8]">
                ABOUT
            </router-link>
            <router-link :to="{ name: 'products' }" class="hover:font-bold hover:text-[#676767]" active-class="font-bold text-[#84BAE8]">
                PRODUCTS
            </router-link>
            <router-link to="/articles" class="hover:font-bold hover:text-[#676767]" active-class="font-bold text-[#84BAE8]">
                ARTICLES
            </router-link>
        </ul>
        ...
        <div class="flex gap-8 justify-end items-center w-[360px]">
            <ul class="flex justify-center items-center mb-0 gap-8 text-[16px] font-['Antique'] font-[400] text-[#888888]">
